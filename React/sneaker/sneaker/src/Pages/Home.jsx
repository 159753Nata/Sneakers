    ...
    <>
      ...
      <div className="content">
            ...
            <div className="search-block">
                ...
                <img onClick={() => dispatch ({type: "CLEAR_INPUT"})} 
                className={inputValue ? "cross" : "display-none"} src="/img/cross1.png" width={18} height={18} alt="Cross" />
            </div>
          
        <div className="ds-f">
           {sneakersArr.filter((elem,index) => elem.title.toLowerCase(). includes(inputValue.toLowerCase())).map((elem, index) => <Card title={elem.title} price={elem.price} 
